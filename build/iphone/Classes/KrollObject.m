...
//@interface NewTemplateObject : NSObject
//@end

@interface NewTemplateObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NewTemplateObject class]])
		{
			for (NSString *key in [[(NewTemplateObject*)o modules] allKeys])
			{
