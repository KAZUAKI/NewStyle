...
// in simulator we redefine to format for NewTemplate Developer console
...
{\
	NSString * exceptionName = [@"org.newtemplate." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.newtemplate";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UINewTemplateNativeItemNone = -1, 
	UINewTemplateNativeItemSpinner = -2,
	UINewTemplateNativeItemProgressBar = -3,
	
	UINewTemplateNativeItemSlider = -4,
	UINewTemplateNativeItemSwitch = -5,
	UINewTemplateNativeItemMultiButton = -6,
	UINewTemplateNativeItemSegmented = -7,
	
	UINewTemplateNativeItemTextView = -8,
	UINewTemplateNativeItemTextField = -9,
	UINewTemplateNativeItemSearchBar = -10,
	
	UINewTemplateNativeItemPicker = -11,
	UINewTemplateNativeItemDatePicker = -12,
	
	UINewTemplateNativeItemInfoLight = -13,
	UINewTemplateNativeItemInfoDark = -14,
	
	UINewTemplateNativeItemDisclosure = -15,
	
	UINewTemplateNativeItemContactAdd = -16
};
